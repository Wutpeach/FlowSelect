// MR9 mechanics-adaptation capture harness.
...
// seven ordered frames plus one reduced-motion frame plus a readout log.
// The contact sheet + pixel perimeter analysis are separate evidence steps.
import { chromium } from "playwright";
import { mkdirSync, writeFileSync } from "node:fs";

const LAB_URL = "http://127.0.0.1:1421/lab.html";
const OUT = "D:/Ameow/.cindy-worktrees/mr9-fullscreen-activation-fx/.trellis/tasks/08-15-mr9-fullscreen-activation-fx-progress-visual-refinement/research/mr9-mechanics-adaptation";
mkdirSync(OUT, { recursive: true });

// Seven phases matching the Paper reference arc (top-edge onset -> growth ->
// inward shell + morphing cavity -> coordinated peak -> contraction/exit).
const TARGETS = [
  { name: "f1-onset", k: 0.05 },
  { name: "f2-growth", k: 0.18 },
  { name: "f3-shell", k: 0.30 },
  { name: "f4-cavity", k: 0.44 },
