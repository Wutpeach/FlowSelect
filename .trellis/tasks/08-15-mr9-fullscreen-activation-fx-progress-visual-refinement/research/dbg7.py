...
print("posY",posY,"mcs",mcs,"scaledUV",scaledUV,"center",[0.5,posY-0.2],"r",innerR,outerR,"circle",s)
s=pow(s,1.4)*1.2
pos=posY-uv[1]; edge=1.2
topF=lst(-0.4,0.0,pos)*(1.0-sst(0.0,edge,pos))
print("pos",pos,"lst:",lst(-0.4,0.0,pos),"sst(0,1.2,pos):",sst(0.0,1.2,pos),"topF:",topF)
topF=pow(topF,3.0)
mixer=1.0-sst(0.0,0.3,pos)
print("topF^3",topF,"mixer",mixer,"result",clamp(0.0,1.0,mix(topF,s,mixer)))
