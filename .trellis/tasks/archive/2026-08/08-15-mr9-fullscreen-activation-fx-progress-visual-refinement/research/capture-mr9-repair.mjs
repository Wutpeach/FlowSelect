// MR9 core-removal repair — capture harness.
...
// research/mr9-core-removal/ (new evidence folder for the repair).
import { chromium } from "playwright";
import { mkdirSync, writeFileSync } from "node:fs";

const LAB_URL = "http://127.0.0.1:1421/lab.html";
const OUT = "D:/Ameow/.cindy-worktrees/mr9-fullscreen-activation-fx/.trellis/tasks/08-15-mr9-fullscreen-activation-fx-progress-visual-refinement/research/mr9-core-removal";
...
// clear the lab heatmap and verify the renderer is back to heatmapMode 0 with
// no texture bound on unit 0 (single-canvas, no leftover GPU material).
