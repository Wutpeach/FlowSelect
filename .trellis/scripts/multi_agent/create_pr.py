...
Note: This script performs git commit as part of the final PR flow.
Outside this script, agents may also commit when the human explicitly
...
def main() -> int:
    ...
    target_dir_path_input = Path(target_dir)
    if target_dir_path_input.is_absolute():
        target_dir_path = target_dir_path_input
    else:
